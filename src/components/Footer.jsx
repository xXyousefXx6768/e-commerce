        ...
        <Row className="mb-3">
          ...
          <Col md={2}>
            ...
            <ul className="list-unstyled">
              ...
              <li className='mb-md-1'><img src="path/to/google-play-badge.png" alt="Google Play" /></li>
              <li className='mb-md-1'><img src="path/to/app-store-badge.png" alt="App Store" /></li>
              <li>
